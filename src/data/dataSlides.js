...
export default [
    {
        ...
        client: "Milliman",
        clientId: "milliman",
        url: "//us.milliman.com/en/products/datalytics-defense",
        role: "Senior UI Developer",
        projectName: "E-Billing and Analytics Solution",
        projectDescription: "E-Billing and Analytics SaaS",
        fragment: "#/work/milliman",
        skills: "TypeScript, C#, Node.js, Webpack, Azure, GIT, Knockout.js, HTML5, CSS3, jQuery",
    ...
    },
    {
        ...
        client: "Innovata LLC.",
        clientId: "innovata",
        url: "//rtw.oneworld.com/rtw/",
        role: "Front End Web Developer",
        projectName: "Flight Itinerary Scheduler",
        projectDescription: "SPA for airline industry",
        fragment: "#/work/innovata",
        skills: "JavaScript, Require.js, Knockout.js, HTML5, Google Maps, jQuery, oAuth",
        software: "Sublime Text 2, Visual Studio 2012",
        longDesc:
            "<p>Worked as front-end developer to deliver a single page javascript application to a leading global airline alliance comprised of 13 different airlines. The application functions as an itinerary planner, flight selection, and booking tool for flights that will take you around the world. It has validation rules that guide you towards picking a valid itinerary of destinations and flights.</p><p>The javascript application uses javascript, consumes json data, and communicates with several C# webservices. The javascript frameworks are knockout.js, require.js, jQueryUI, jQuery, and the Google Maps V3 API</p><p>I was responsible for integrating the Google Maps API. Developing user workflow logic. Integrating and customizing jQuery datepicker and autocomplete as defined by the business logic. Consume and bind JSON data to the UI. Form validation. Build view models.</p>",
        image: {
            width: "100%",
            height: "360",
    ...
    {
        order: 3,
        client: "Pratt Industries Inc.<sup>&reg;</sup>",
        clientId: "prattIndustries",
        role: "Front End Web Developer",
        projectName: "Pratt Industries Corporate Site",
        projectDescription: "Corporate Sites built on WordPress",
        url: "http://www.prattindustries.com/",
        fragment: "#/work/prattIndustries",
        skills: "JavaScript, PHP, BASH, Backbone.js, HTML5, CSS3, jQuery, Image Optimization",
        software:
            "Sublime Text 2, WordPress, Dragon Disk, Photoshop CS5, Visual Studio 2010",
        longDesc:
            '<p>Pratt Industries is a leading multi-national recycling and paper product manufacturing company.<!-- 5th largest converter of recycled to box in the US, 5 billion $ company --> They provide corrugate products to some big names in the retail industry including: Home Depot and Walmart. <a href="http://www.prattindustries.com" target="_blank">Pratt Industries</a></p><p>I was contracted by Pratt Industries to build a network of corporate sites for each company articleision using the WordPress Multisite platform. I hand coded a full featured site that contains custom javaScript slideshows, accordions, AJAX contact forms, form error handling, JSON webservices, and MailChimp API integration leveraging jQuery and PHP.</p><p>A highlight of the project included building an automated process to synchronize the code base between two servers using Amazon S3, Linux Bash scripting, and S3CMD.</p>',
        image: {
            width: "100%",
            height: "360",
